...
public class Adapter_QuanLyKhachHang extends RecyclerView.Adapter<Adapter_QuanLyKhachHang.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnXoaKhachHang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferences sharedPreferences = context.getSharedPreferences("thongtin", MODE_PRIVATE);
                String loaitaikhoan = sharedPreferences.getString("loaitaikhoan", "");
                if (loaitaikhoan.equals("admin")) {
                    Toast.makeText(context, "Admin không thể xóa", Toast.LENGTH_SHORT).show();
                } else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView txtHovaTen, txtUsername, txtDiaChi, txtPassword, txtEmail, txtSoDienThoai,txtMaNguoiDung;
        ImageView btnSuaKhachHang, btnXoaKhachHang;

        public ViewHolder(@NonNull View view) {
            super(view);
            txtMaNguoiDung = view.findViewById(R.id.txtMaNguoiDung);

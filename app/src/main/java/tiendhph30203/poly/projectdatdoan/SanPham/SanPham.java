...
//    String anhsanpham;
    ...
    public SanPham(int masanpham, byte[] anhsanpham, String linkanhsanpham, String tensanpham, String giasanpham, String giamgia, int soluongtrongkho, int maloai, String ngaysanxuat, String hansudung, int soLuongdamua) {

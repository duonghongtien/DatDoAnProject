...
//    }
    ...
    public List<GioHang> getData(String sql, String... selectionArgs) {
        ...
        while (cursor.moveToNext()) {
            GioHang gioHang = new GioHang();
            gioHang.setMasanpham(cursor.getInt(cursor.getColumnIndex("masanpham")));
            gioHang.setAnhsanpham(cursor.getBlob(cursor.getColumnIndex("anhsanpham")));
            gioHang.setLinkanhsanpham(cursor.getString(cursor.getColumnIndex("linkanhsanpham")));
            gioHang.setTensanpham(cursor.getString(cursor.getColumnIndex("tensanpham")));
            gioHang.setSoluong(cursor.getInt(cursor.getColumnIndex("soluong")));
            gioHang.setGiasanpham(cursor.getInt(cursor.getColumnIndex("giasanpham")));
            gioHang.setManguoidung(cursor.getInt(cursor.getColumnIndex("manguoidung")));
            list.add(gioHang);
        }
        return list;
    }

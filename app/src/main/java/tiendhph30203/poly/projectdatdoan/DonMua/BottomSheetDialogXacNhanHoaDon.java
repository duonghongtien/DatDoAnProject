...
import tiendhph30203.poly.projectdatdoan.TablayoutDonMua;
import tiendhph30203.poly.projectdatdoan.Tablayoutactivity;
...
public class BottomSheetDialogXacNhanHoaDon extends BottomSheetDialogFragment {
    ...
    private void xuatHoaDon() {
        ...
        hoaDon.setHoten(mOrder.getTenKhachHang());
        Log.d("TAG", "Tenkhachhang: " + mOrder.getTenKhachHang());
        hoaDon.setTongtien((int) mOrder.getTongTien());
        Log.d("TAG", "Tongtien: " + mOrder.getTongTien());
        hoaDon.setTrangthai(0);
        if(mOrder.getMaKH() != 0){
            hoaDon.setManguoidung(mOrder.getMaKH());
        }

        Log.d("TAG", "Tongtien: " + mOrder.getMaKH());
